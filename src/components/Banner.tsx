export default function Banner() {
    return (
        <section id="home" className="h-[max(calc(100vh-188px), 900px)] md:max-h-[680px] flex justify-center scroll-mt-24 md:scroll-mt-32">
            <div className="bg-snow w-80 md:w-full rounded text-brownie h-full overflow-hidden">
