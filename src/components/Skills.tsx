    ...
    return (
        <section id="skills" className="scroll-mt-32">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-8 mx-auto w-fit">
                {SKILLS.map((skill) => (
                    <div key={skill.name} className="flex flex-col gap-3 pt-2 items-center justify-center bg-snow rounded aspect-square w-36 h-36 transition duration-300 hover:scale-105">
